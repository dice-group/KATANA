...
public abstract class SparqlQueries {
	...
	public static String getResourceQuery(String classname) {
	...
	public static String getCBDQuery(String resourceURI) {
	...
	public static String getFunctionalPropertiesResourcesQuery(String classname) {
	...
	public static String getSampleDatasetQuery(Resource res) {
